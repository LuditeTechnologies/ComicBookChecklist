...
public class TitleTestSpiderman extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_title_test_spiderman);
        ...
        query3.whereContains("name", "SPIDERMAN");
        ...
        return new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> list, ParseException e) {
                ...
                if (list.size() == _queryLimit) {
                    ...
                    TextView titles = (TextView) findViewById(R.id.txtTitlesSpiderman);
                    String text = "";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_title_test_spiderman, menu);
        return true;
    }
